...
public class FollowUserEscDemo {
    ...
    /*@ public normal_behavior
      ...
      @ requires 0 <= id1 && id1 < users.length;
      @ requires 0 <= id2 && id2 < users.length;
      @ requires id2 < following.length && id1 < followers.length;
      @ requires following[id2] != null && id1 < following[id2].length;
      @ requires followers[id1] != null && id2 < followers[id1].length;
      @ requires users[id1] && users[id2] && id1 != id2;
      @ requires !following[id2][id1];
      @ assignable following[id2][id1], followers[id1][id2];
      @ ensures following[id2][id1];
      @ ensures followers[id1][id2];
      @*/
    public void followUserWrongSpec(int id1, int id2) {
        following[id2][id1] = true;
        followers[id1][id2] = true;
    }
}
